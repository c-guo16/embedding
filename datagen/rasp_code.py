...
if __name__ == '__main__':
    ...
    while (True):
        ...
        ret, img_sample = cap.read()  # 读取摄像头图像
        img_sample = cv2.resize(img_sample[50:-50, 50:-50], (0, 0), fx=0.25, fy=0.25)
        ...
        img3 = cv2.drawMatchesKnn(img_sample, kp_sample, best_img_source[0], best_img_source[3], best_matches, None,
                                  flags=2)

        cv2.imshow("frame", img3)  # 显示图片
